...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const toolPages: MetadataRoute.Sitemap = [
    ...
    {
      url: `${BASE_URL}/tools/media-toolkit/audio-converter`,
      lastModified: new Date(),
      changeFrequency: "weekly" as const,
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/tools/media-toolkit/video-compressor`,
      lastModified: new Date(),
      changeFrequency: "weekly" as const,
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/tools/media-toolkit/video-converter`,
      lastModified: new Date(),
      changeFrequency: "weekly" as const,
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/tools/media-toolkit/audio-trimmer`,
      lastModified: new Date(),
      changeFrequency: "weekly" as const,
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/tools/media-toolkit/image-converter`,
      lastModified: new Date(),
      changeFrequency: "weekly" as const,
      priority: 0.8,
    },
    ...
    {
      url: `${BASE_URL}/tools/media-toolkit/audio-extractor`,
      lastModified: new Date(),
      changeFrequency: "weekly" as const,
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/tools/media-toolkit/subtitle-extractor`,
      lastModified: new Date(),
      changeFrequency: "weekly" as const,
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/tools/media-toolkit/metadata-editor`,
      lastModified: new Date(),
      changeFrequency: "weekly" as const,
      priority: 0.8,
    },
