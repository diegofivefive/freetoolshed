...
import { ACCENT_PRESETS } from "@/lib/pay-stub/constants";
import type { PayStubAction } from "@/lib/pay-stub/types";
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-muted-foreground">
        Applied to headings, tables, and accents in your pay stub PDF.
      </p>
    </div>
  );
}
